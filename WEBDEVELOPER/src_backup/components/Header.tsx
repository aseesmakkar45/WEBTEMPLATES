      ...
      <header
        style={{
          ...
          background: pathname === "/about" 
            ? (scrolled ? "rgba(27,36,27,0.96)" : "transparent") 
            : (scrolled ? "rgba(238,233,223,0.96)" : "var(--bg)"),
          backdropFilter: scrolled ? "blur(16px)" : "none",
          WebkitBackdropFilter: scrolled ? "blur(16px)" : "none",
          boxShadow: scrolled 
            ? (pathname === "/about" ? "0 1px 0 rgba(255,255,255,0.08)" : "0 1px 0 rgba(0,0,0,0.08)") 
            : "none",
        }}
      >
        {/* Logo */}
        <Link href="/" style={{ textDecoration: "none", display: "flex", alignItems: "center", gap: "10px", marginRight: "auto" }}>
          ...
          <div style={{
            ...
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <path d="M13 2L4.5 13.5H11 L11 22 L19.5 10.5H13 L13 2Z" fill="#161616"/>
            </svg>
          </div>
          <span style={{
            fontFamily: "var(--font)",
            fontWeight: 800,
            fontSize: "15px",
            color: pathname === "/about" ? "#ffffff" : "var(--text)",
        ...
        <nav className="desk-nav" style={{
          ...
          {NAV_LINKS.map((link) => {
            ...
            const linkColor = pathname === "/about" 
              ? (active ? "#ffffff" : "rgba(255,255,255,0.65)") 
              : (active ? "var(--text)" : "#5a5a5a");
            return (
              <Link
                key={link.href}
                href={link.href}
                ...
                onMouseEnter={(e) => ((e.currentTarget as HTMLElement).style.color = pathname === "/about" ? "#ffffff" : "var(--text)")}
        ...
        <button
          ...
          style={{
            display: "none",
            background: "none",
            border: pathname === "/about" ? "1.5px solid rgba(255,255,255,0.15)" : "1.5px solid rgba(0,0,0,0.15)",
            borderRadius: "8px",
            cursor: "pointer",
            padding: "7px 9px",
            color: pathname === "/about" ? "#ffffff" : "var(--text)",
